...
public class OIDCUtil {
	private static final String CLIENT_ID = "778868719904-c2a2apdauidei3uieponuoiru350adm6.apps.googleusercontent.com"; // 用戶端編號
	private static final String CLIENT_SECRET = "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"; // 用戶端密鑰
