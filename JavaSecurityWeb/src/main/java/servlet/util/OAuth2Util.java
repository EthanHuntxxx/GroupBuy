...
public class OAuth2Util {
	...
	public final static String CLIENT_ID = "12ed226e195b7e5fd698";  //你的 Client ID
    private final static String CLIENT_SECRET = "d1270248bf379116387558e5289501704719b9ab";	  //你的 Secure ID
    public final static String REDIRECT_URI = "http://localhost:8080/GroupBuy/mvc/secure/callback/oauth2";
